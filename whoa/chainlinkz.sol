...
contract APIConsumer is ChainlinkClient {
    ...
    function requestVolumeData() public returns (bytes32 requestId) 
    {
        ...
        request.add("get", "https://api.etherscan.io/api?module=proxy&action=eth_call&to=0xB6eD7644C69416d67B522e20bC294A9a9B405B31&data=4ef37628&tag=latest&apikey=YourApiKeyToken");
